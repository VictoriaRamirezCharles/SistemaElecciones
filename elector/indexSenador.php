      ...
      <?php else: ?>
        ...
        <div id="recommended-stories">
          <div style="height: 60px; background-color:#072F5F;  padding-top: 10px; border-bottom:#ccc 1px solid;">
            <center><span style="font-zize:10px; color:#fff;"><h4 style="color:#fff;"">LISTADO DE CANDIDATOS(AS) A LA SENADURIA</h4></span></center>          
          </div> 
        </div>
        </br>
        ...
        <?php if(!$ejercido):?>
          <?php foreach($candidatos as $candidato):?>
            ...
            <?php if($candidato->Estado ===1 && $candidato->PuestoNombre === 'Senador'):?>
